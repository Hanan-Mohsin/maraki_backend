...
const {viewedNotification,newNotification} = require('../startup/connection');
...
router.get('/user', auth,async(req,res) => {
    const notifications = await Notification
    .find({user:req.user._id, isDeleted: false}).select('-isDeleted');
...
router.post('/',auth,async(req,res) => {
    ...
    notification = await newNotification(notification);
